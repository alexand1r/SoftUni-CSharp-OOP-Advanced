...
public class MissionController
{
    ...
    public Army Army { get { return this.army; } set { this.army = value; } }
    public WareHouse WareHouse { get { return this.wareHouse; } set { this.wareHouse = value; } }
    ...
    public void CreateMission(string name, int score)
    {
        this.Missions.Enqueue(this.missionFactory.CreateMission(name, score));
    }
