namespace RecyclingStation.Core
{
    ...
    public class CommandHandler : ICommandHandler
    {
        ...
        private IWaste InstantiateWaste(string[] parameters)
        {
            ...
            Type garbageType = Assembly.GetExecutingAssembly().DefinedTypes
        ...
        private IManagementRequirement InstantiateManagementRequirement(string[] parameters)
        {
            ...
            IManagementRequirement requirement =
                new ManagementRequirement(minEnergyBalance, minCapitalBalance, garbageType);
